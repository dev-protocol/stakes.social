...
export function whenDefinedAll<D1, F>(depends: [D1], fn: (d: [NonNullable<D1>]) => F): F
export function whenDefinedAll<D1, D2, F>(depends: [D1, D2], fn: (d: [NonNullable<D1>, NonNullable<D2>]) => F): F
